...
// Property 'computeOffsets' does not exist on type 'Raycaster'. 이 오류를 위해서 타입 확장
interface ExtendedRaycaster extends THREE.Raycaster {
  computeOffsets?: ({
    clientX,
    clientY,
  }: {
...
export function ScrollControls({
  ...
  // Cannot redeclare block-scoped variable 'raycaster' 라는 오류는 이미 같은 스코프 내에서
  // 'raycaster'라는 변수가 선언되었기 때문에 발생합니다.
  const raycaster = useThree().raycaster as ExtendedRaycaster;
