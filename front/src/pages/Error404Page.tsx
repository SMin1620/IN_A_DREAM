...
const Error404Page = () => {
  ...
  const setZeroAndBeamAppear = () => {
    const number0Soaking = document.getElementById("number-0-soaking");
    if (number0Soaking) {
      number0Soaking.removeEventListener("animationend", setZeroAndBeamAppear);
      number0Soaking.setAttribute("id", "number-0");
    }

    const ufoBeamDisappearing = document.getElementById(
      "UFO-beam-disappearing"
    );
    if (ufoBeamDisappearing) {
      ufoBeamDisappearing.setAttribute("id", "UFO-beam");
    }

    const number0 = document.getElementById("number-0");
    if (number0) {
      number0.addEventListener("animationend", setZeroAndBeamDisappear);
    }
  };
  ...
  const setZeroAndBeamDisappear = () => {
    ...
    if (number0) {
      number0.removeEventListener("animationend", setZeroAndBeamDisappear);
      number0.setAttribute("id", "number-0-soaking");
    }

    const ufoBeam = document.getElementById("UFO-beam");

    if (ufoBeam) {
      ufoBeam.setAttribute("id", "UFO-beam-disappearing");
    }

    const soakingNumberElement = document.getElementById("number-0-soaking");

    if (soakingNumberElement) {
      soakingNumberElement.addEventListener(
        "animationend",
